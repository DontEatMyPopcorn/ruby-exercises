...
def find_favorite(array_of_hash_objects)
  ...
  # array_of_hash_objects.select{|obj| true}  
  # array_of_hash_objects[0]
  array_of_hash_objects.find { |u| u[:is_my_favorite?] == true }
  # array_of_hash_objects.select{|obj| obj.include?([:name, 'Ruby'])}  
